...
def agent(observation, configuration=None):
    ...
    if 288 <= step < 696:_R37_HORIZONS[player] = 9  # lab: horizon sweep 9 on the open3_carrot base. Horizon 12 is worth ~+1000 median and beats this base 123-7 over 130 games, but took 2 paired regressions and a gate VETO (iteration 32/37); 9-11 were never tested. Looking for most of that gain at <=1 regression.  # lab v43_lead8: 4->8; measured 6 > 5 > 4 on this base
