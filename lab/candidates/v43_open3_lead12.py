...
def agent(observation, configuration=None):
    ...
    if 288 <= step < 696:_R37_HORIZONS[player] = 12  # lab: retest of horizon 12 on the open3 base; on the open55 base it beat horizon 8 48-2 but regressed on 2 seeds  # lab v43_lead8: 4->8; measured 6 > 5 > 4 on this base
