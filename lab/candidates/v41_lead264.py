...
# lab candidate v41_lead264: reserve/2-step sell lead window starts at step 264 instead of 288
# (ladder replays 109155888 ShadowT_T, 109173772 Adam: their only market change vs v41 is a
# 2-step-early MILK sale at step 265, and both beat v41 by 12 and 6 coins).
...
def _r36_reserve(obs,action):
    ...
    if not 264<=step<696:return action
